export const translations = {
  en: {
    ...
    autoCheckInLimit: "Instant check-in only available before {time}. Use Manual Entry.",
  ...
  vi: {
    ...
    unauthorizedLocationMessage: "Bạn không ở trong khu vực văn phòng.",
    ...
    checkSettings: "Vui lòng kiểm tra cài đặt trình duyệt (biểu tượng ổ khóa) để cấp quyền truy cập vị trí.",
    ...
    autoCheckInLimit: "Check-in nhanh chỉ mở trước {time}. Hãy dùng nhập thủ công.",
